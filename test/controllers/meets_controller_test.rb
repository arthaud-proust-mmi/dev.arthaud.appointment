...
class MeetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meet" do
    assert_difference("Meet.count") do
      post meets_url, params: { meet: { planned_at: @meet.planned_at, service_id: @meet.service_id, user_id: @meet.user_id } }
    end
  ...
  test "should update meet" do
    patch meet_url(@meet), params: { meet: { planned_at: @meet.planned_at, service_id: @meet.service_id, user_id: @meet.user_id } }
